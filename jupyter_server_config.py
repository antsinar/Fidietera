...
try:
    ...
    c.IdentityProvider.token = environ.get("STUDENT_ID", "config-token")
except:
    c.IdentityProvider.token = "exception-token"
# ------------------------------------------------------------------------------
...
#  Choices: any of ['shake_256', 'sha512', 'sha3_224', 'sm3', 'blake2b', 'sha3_256', 'md5', 'sha512_224', 'sha512_256', 'ripemd160', 'md5-sha1', 'sha1', 'sha384', 'sha3_512', 'sha3_384', 'blake2s', 'shake_128', 'sha256', 'sha224']
#  Default: 'sha256'
...
#  Choices: any of ['sha3_256', 'md5', 'sha3_224', 'sha1', 'sha384', 'blake2b', 'sha3_384', 'sha3_512', 'blake2s', 'sha512', 'sha256', 'sha224']
#  Default: 'sha256'
